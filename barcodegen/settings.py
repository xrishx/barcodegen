"""
Django settings for barcodegen project.
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 50,  # You can set this to any number, e.g., 50, 100,
...
# REPLACEMENT FOR: ACCOUNT_AUTHENTICATION_METHOD
# This tells allauth to use the username for login.
ACCOUNT_LOGIN_METHODS = ['username']

# REPLACEMENT FOR: ACCOUNT_EMAIL_REQUIRED and ACCOUNT_USERNAME_REQUIRED
# This tells allauth that the 'username' field on the user model is what we use for identity.
ACCOUNT_USER_MODEL_USERNAME_FIELD = 'username'

# This tells allauth that email is NOT a required field during signup.
...
#         'NAME': 'postgres',
#         'USER': 'postgres.tgorlthjyrkaaysegcka',
#         'PASSWORD': 'barcodegen-database',
