# core/management/commands/import_inventory.py
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            for sheet in category_sheets:
                # ... (Sheet processing setup is the same) ...
                ...
                for row_num, row in enumerate(item_rows, start=2):
                    ...
                    # --- NEW: Step 2 - Add the valid SKU to our master set ---
